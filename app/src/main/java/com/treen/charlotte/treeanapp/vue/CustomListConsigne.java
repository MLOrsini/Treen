...
public class CustomListConsigne extends ArrayAdapter {
    ...
    public CustomListConsigne(Activity context, String[] nameArrayParam, String[] infoArrayParam, int[] consignesArrayParam){
